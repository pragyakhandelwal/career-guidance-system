...
public class MainActivityLogin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        eLogin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(userName.isEmpty() || userPassword.isEmpty())
                {
                    ...
                    Toast.makeText(MainActivityLogin.this, "Please enter name and password!", Toast.LENGTH_LONG).show();
                    ...
                    if (!isValid) {
                        ...
                        if (counter == 0) {
                            ...
                            Toast.makeText(MainActivityLogin.this, "You have used all your attempts try again later!", Toast.LENGTH_LONG).show();
                        }
                        /* Display error message */
                        else {
                            Toast.makeText(MainActivityLogin.this, "Incorrect credentials, please try again!", Toast.LENGTH_LONG).show();
                        }
                    }
                    /* If valid */
                    else {
                        ...
                        startActivity(new Intent(MainActivityLogin.this, Tab1.class));
                    }
        ...
        eSignUp.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(MainActivityLogin.this, RegistrationActivity.class));
            }
        });
    }
}
